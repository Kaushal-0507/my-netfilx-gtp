...
const VideoBackground = ({ movieId, image }) => {
  ...
  return (
    <div className="w-full h-full overflow-hidden">
      <div className="absolute left-64 top-0 h-full w-1/3 bg-gradient-to-r from-black to-transparent z-10 pointer-events-none"></div>
      {/* <img
      ...
      <iframe
        ...
        className="absolute top-0 left-32 w-full h-[550px] pointer-events-none"
        allow="autoplay"
        onLoad={() => {
