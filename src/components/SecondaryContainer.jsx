...
const SecondaryContainer = () => {
  ...
  return (
    <div>
      {filter === "Home" && (
        <div className="absolute top-[55%] md:top-[84%] z-30 left-3 md:left-10 w-[92%] pb-14 md:pb-0 md:mb-14 md:w-[93%] text-white">
      ...
      {filter === "Movies" && (
        <div className="absolute top-[55%] md:top-[84%] z-30 left-2 md:left-10 w-[93%] pb-14 md:pb-0 text-white">
          <MovieList title={"Now Playing"} movies={movies?.nowPlayingMovies} />
          <MovieList title={"Popular Movies"} movies={movies?.popularMovies} />
          <MovieList title={"Top Rated Movies"} movies={movies?.topRated} />
          <MovieList
